...
%token        FIELD_INCLUDE_MASK FIELD_MULTI_SELECT
...
valid_field        : screen_pos 
                ...
                | field_multi_select
                {
                        strcpy (eott, "field_multi_select");
                        if (debug)
                        {
                                fprintf (stderr, 
                                "\nParseDeSrn.y:\t<.DEFINE_SCREEN> field_multi_select");
                                fflush (stderr);
                        }
                }
                ;
